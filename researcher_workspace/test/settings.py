...
# in the Django settings, mark the Guacamole models as managed so that
# we can populate them in unit tests.  Otherwise, the model should
# not be managed.  The real table schemas are SQL / sqlite
...
#
# We DON'T want the local settings influencing the unit tests!
#
