...
# VM managers timeouts and retry counts.
LAUNCH_WAIT = 300
REBOOT_WAIT = 300
REBOOT_CONFIRM_WAIT = 10
REBOOT_CONFIRM_RETRIES = 5
RESIZE_WAIT = 300
RESIZE_CONFIRM_WAIT = 240
SHELVE_WAIT = 300
TERMINATION_CLEANUP_AGE = 300
ARCHIVE_WAIT = 18000
ARCHIVE_POLL_WAIT = 60
INSTANCE_POLL_DELETED_WAIT = 1800
INSTANCE_POLL_DELETED_RETRIES = 5
INSTANCE_POLL_SHUTOFF_WAIT = 10
INSTANCE_POLL_SHUTOFF_RETRIES = 5
BACKUP_POLL_DELETED_WAIT = 30
BACKUP_POLL_DELETED_RETRIES = 5
VOLUME_POLL_DELETED_WAIT = 30
VOLUME_POLL_DELETED_RETRIES = 5
VOLUME_POLL_AVAILABLE_WAIT = 10
VOLUME_POLL_AVAILABLE_RETRIES = 12
VOLUME_CREATION_WAIT = 180
INSTANCE_LAUNCH_WAIT = 180
